///////////////////////////////////////////////////////////////////
//            Module 4 Setting up a timer for counting seconds   //
///////////////////////////////////////////////////////////////////
...
int main()
{
	...
	//Set up timer 1 as a counter for 0.1 seconds
    TCCR1A = 0;             // normal mode, no PWM
    TCCR1B = (1 << CS10) | (1 << CS12) | (1<<WGM12);   //Prescaler = 1/1024 based on system clock 16 MHz
                                                       //This means 15625 increase of timer 1 per second
                                                       //+ enable reset of counter register
    ...
    for(;;) 
	{
		lcd_putnumber(1, 0, runsecs10, -1, 1, 'l', 0);
	}
	return 0;
}
