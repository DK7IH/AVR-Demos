///////////////////////////////////////////////////////////////////
//            Module 6 PWM (based on analog control voltage)     //
///////////////////////////////////////////////////////////////////
...
int main()
{
	...
	//Setup timer 1 for PWM an configure PWM output port
	DDRB |= (1 << PB1);
    ...
    for(;;) 
	{
		pwm = get_adc(0) >> 2; //Get PWM value from ADC voltage and reduce from 10 to 8 bits
		lcd_putnumber(1, 0, pwm, -1, -1, 'l', 0);
		OCR1A = pwm;
		wait_ms(300);
		lcd_putstring(1, 0, "    ");
	}
