...
// VCC (red)          +3.3V                                      // 
// GND (black)        Ground                                     // 
// CS (blue)          Chip select line (0 = enable)              //
// RESET (white)      LCD Reset pin (active = 0)                 //
// A0 (green)         D/C pin (choosing data (1) or command (0)) //
// DATA (yellow)      SPI data                                   // 
// CLK (lightblue)    SPI clock                                  //
// LED                tie to 3.3V+                               //
///////////////////////////////////////////////////////////////////
