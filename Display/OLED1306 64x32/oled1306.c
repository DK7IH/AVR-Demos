...
void oled_cls(void);
void oled_putchar1(int, int, int);
...
int main(void)
{
    ...
    oled_putstring(0, 0, "1111111111", 0);
    oled_putstring(0, 1, "2222222222", 0);
    oled_putstring(0, 2, "3333333333", 0);
    oled_putstring(0, 3, "4444444444", 0);
    oled_putstring(0, 4, "5555555555", 0);
    oled_putstring(0, 5, "6666666666", 0);
    oled_putstring(0, 6, "7777777777", 0);
    oled_putstring(0, 7, "8888888888", 0);
